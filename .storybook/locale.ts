...
let locale: Record<string, string> = {
  ...
  braveAdsTitle: 'Presearch Ads',
  braveAdsLaunchTitle: 'Presearch Ads has arrived!',
  ...
  braveRewards: 'Presearch Rewards',
  ...
  braveRewardsTitle: 'Presearch Rewards',
  ...
  rewardsWidgetBraveRewards: 'Presearch Rewards',
  saveAd: 'Save',
  saveAsFile: 'Save',
  saved: 'Saved',
  ...
  walletDisconnect: 'Log out from Presearch Rewards',
  ...
  whyBraveRewards: 'Why Presearch Rewards?',
  ...
  whyBraveRewardsDesc2: 'Well, you\'ve come to the right place. Presearch welcomes you to the new internet. One where your time is valued, your personal data is kept private, and you actually get paid for your attention.',
  whyHow: 'Why & How',
  ...
  showBraveStats: 'Show Presearch Stats',
  showBinance: 'Show Binance',
  braveTalkWidgetTitle: 'Presearch Talk',
  ...
  braveTodayIntroDescription: `Presearch News is ad-supported with completely private and anonymized ads matched on your device. Your personal information always stays private, per our $1privacy policy$2.`,
  braveTodayOptInActionLabel: 'Show Presearch News',
  braveTodayOptOutActionLabel: 'No thanks',
  braveTodayScrollHint: 'Scroll for Presearch News',
