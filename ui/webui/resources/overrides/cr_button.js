...
export default html`
  <style>
    ...
    :host(:not([style])) {
      ...
      --brave-brand-color: #287FE5; /* orange400 */
      --brave-primary-hover: #2471CC; /* orange300 */
      --brave-default-hover: rgba(40, 127, 229, 0.1); /* orange400 */
      --brave-focus-outline: rgba(40, 127, 229, 0.4); /* orange400 */
