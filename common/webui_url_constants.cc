...
const char kRewardsPageHost[] = "";
const char kRewardsInternalsHost[] = "";
...
const char kBraveUIRewardsURL[] = "chrome://";
...
const char kBraveUIWalletURL[] = "chrome://";
const char kBraveUIWalletOnboardingURL[] = "presearch://";
const char kBraveUIWalletPanelURL[] = "chrome://";
const char kWalletPanelHost[] = "";
const char kVPNPanelURL[] = "chrome-untrusted://";
const char kVPNPanelHost[] = "";
const char kBraveUIWalletPageURL[] = "chrome://";
const char kWalletPageHost[] = "";
const char kExtensionSettingsURL[] = "presearch://settings/extensions";
const char kWalletSettingsURL[] = "presearch://settings";
const char kBraveSyncPath[] = "#";
const char kBraveSyncSetupPath[] = "#";
