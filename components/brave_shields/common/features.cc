...
// When enabled, Presearch will block first-party requests that appear in a filter
// list when Shields is in "standard" blocking mode. When disabled, Presearch will
...
// When enabled, Presearch will issue DNS queries for requests that the adblock
...
// When enabled, Presearch will apply HTML element collapsing to all images and
...
// When enabled, Presearch will treat "Easylist-Cookie List" as a default,
...
const base::Feature kBraveDomainBlock{"BraveDomainBlock",
                                      base::FEATURE_ENABLED_BY_DEFAULT};
// When enabled, Presearch will attempt to enable 1PES mode in a standard blocking
...
// When enabled, language headers and APIs may be altered by Presearch Shields.
const base::Feature kBraveReduceLanguage{"BraveReduceLanguage",
                                         base::FEATURE_ENABLED_BY_DEFAULT};
// When enabled, Presearch will always report Light in Fingerprinting: Strict mode
